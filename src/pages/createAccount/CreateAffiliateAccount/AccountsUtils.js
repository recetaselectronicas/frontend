...
export const hasError = (accountData) => {
  return Object.keys(accountData).some(key => accountData[key].error);
};

export const calculateErrors = (accountData) => {
  return Object.keys(accountData).reduce((newAccountData, key) => {
